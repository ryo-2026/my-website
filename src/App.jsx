      ...
      <div style={{ width: "100%", maxWidth: 360 }}>
        ...
        {showSafariHint && (
          <div style={{
            ...
            fontSize: 13, color: "#aaa", lineHeight: 1.8, textAlign: "center",
          }}>
            <div style={{ fontSize: 24, marginBottom: 8 }}>🌐</div>
            <div>Safariが開きました。</div>
            <div>Googleログイン完了後、</div>
            <div style={{ color: ACCENT, fontWeight: 700 }}>このアプリに戻ってください。</div>
          </div>
        )}
